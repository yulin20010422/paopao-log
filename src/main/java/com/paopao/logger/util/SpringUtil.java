...
public class SpringUtil implements BeanFactoryPostProcessor, ApplicationContextAware {
    ...
    public static ListableBeanFactory getBeanFactory() {
        ...
        if(null == factory){
            throw new CommonException("No ConfigurableListableBeanFactory or ApplicationContext injected, maybe not in the Spring environment?");
        }
        return factory;
    }
     ...
     * @throws CommonException 当上下文非ConfigurableListableBeanFactory抛出异常
     * @since 5.7.7
     */
    public static ConfigurableListableBeanFactory getConfigurableBeanFactory() throws CommonException {
        ...
        if (null != beanFactory) {
            ...
            throw new CommonException("No ConfigurableListableBeanFactory from context!");
        }
        return factory;
    }
    ...
    public static void unregisterBean(String beanName) {
        ...
        if (factory instanceof DefaultSingletonBeanRegistry) {
            ...
            throw new CommonException("Can not unregister bean, the factory is not a DefaultSingletonBeanRegistry!");
        }
    }
